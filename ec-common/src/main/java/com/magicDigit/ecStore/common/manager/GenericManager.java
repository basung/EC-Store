package com.magicDigit.ecStore.common.manager;
...
/**
 * Date: 2018-11-03-下午12:16
 */
public interface GenericManager<T extends CommonEntity, ID extends Serializable, E extends GlobalException> {

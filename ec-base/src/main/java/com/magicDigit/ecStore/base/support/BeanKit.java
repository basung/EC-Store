...
import com.magicDigit.ecStore.base.utils.Convert;
		    ...
		    if (sourcePd != null) {
			  ...
			  if (readMethod != null && ClassKit.isAssignable(writeMethod.getParameterTypes()[0], readMethod.getReturnType())) {
				try {
				    ...
				    throw new GlobalException(400,ex.getMessage() + "Copy property [{}] to [{}] error: {}" + sourcePd.getName() + targetPd.getName() + ex.getMessage());
				}
			  }
		    }
		}

package com.magicDigit.ecStore.base.utils;

import com.magicDigit.ecStore.base.exception.GlobalException;
import com.magicDigit.ecStore.base.support.*;
...
public class Convert {
    ...
    public static Integer[] toIntArray(boolean isIgnoreConvertError, Object... values) {
	  ...
	  for (int i = 0; i < values.length; i++) {
		...
		if (null == v && isIgnoreConvertError == false) {
		    throw new GlobalException(400,StrKit.format("Convert [{}] to Integer error!", values[i]));
		}
		ints[i] = v;
	  }
	  return ints;
    ...
    public static Long[] toLongArray(boolean isIgnoreConvertError, Object... values) {
	  ...
	  for (int i = 0; i < values.length; i++) {
		...
		if (null == v && isIgnoreConvertError == false) {
		    throw new GlobalException(400,StrKit.format("Convert [{}] to Long error!", values[i]));
		}
		longs[i] = v;
	  }
	  return longs;
    ...
    public static Double[] toDoubleArray(boolean isIgnoreConvertError, Object... values) {
	  ...
	  for (int i = 0; i < values.length; i++) {
		...
		if (null == v && isIgnoreConvertError == false) {
		    throw new GlobalException(400, StrKit.format("Convert [{}] to Double error!" + values[i]));
		}
		doubles[i] = v;
	  }
	  return doubles;
    ...
    public static <T> Float[] toFloatArray(boolean isIgnoreConvertError, Object... values) {
	  ...
	  for (int i = 0; i < values.length; i++) {
		...
		if (null == v && isIgnoreConvertError == false) {
		    throw new GlobalException(400, StrKit.format("Convert [{}] to Float error!" + values[i]));
		}
		floats[i] = v;
	  }
	  return floats;
    ...
    public static Boolean[] toBooleanArray(boolean isIgnoreConvertError, Object... values) {
	  ...
	  for (int i = 0; i < values.length; i++) {
		...
		if (null == v && isIgnoreConvertError == false) {
		    throw new GlobalException(400,StrKit.format("Convert [{}] to Boolean error!", values[i]));
		}
		bools[i] = v;
	  }
	  return bools;

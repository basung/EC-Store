...
@Transactional
@Service
public class RolePermissionServiceImpl extends GenericManagerImpl<RolePermission, String, GlobalException> implements RolePermissionService {
    ...
    protected GenericDao<RolePermission, String> getDao() {
